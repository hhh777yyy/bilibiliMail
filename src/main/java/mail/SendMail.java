...
public class SendMail {
    public static String myEmailAccount = "15626128581@163.com";//邮箱账号
    public static String myEmailPassword = "qwe123";//邮箱密码
...
//        transport.close();
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String text) throws Exception {
        ...
        message.setFrom(new InternetAddress(sendMail, "15626128581@163.com", "UTF-8"));
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail,"1119848245@qq.com", "UTF-8"));
    ...
    public static void main(String[] args) throws Exception {
        sendEmail("这是内容，验证码45845","1119848245@qq.com");
    }
